...
curl -o /usr/local/apache2/conf/flexible-origin.conf \
     https://raw.githubusercontent.com/rafaalpizar/flexible-origin-install/${GIT_BRANCH}/apache/flexible-origin-docker.conf; \
...
curl -o /etc/cron.hourly/flexible-origin_restart \
     https://raw.githubusercontent.com/rafaalpizar/flexible-origin-install/${GIT_BRANCH}/cron/flexible-origin_restart; \
